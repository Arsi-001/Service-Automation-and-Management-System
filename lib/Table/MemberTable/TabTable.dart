...
class TabTable extends StatefulWidget {
  TabTable({super.key, required this.sw});
  final double sw;

  @override
  State<TabTable> createState() => _TabTableState();
}

class _TabTableState extends State<TabTable> {
